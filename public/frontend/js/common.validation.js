$(document).ready(function () {
    ...
    $('#frm_member_registration').validate({ // initialize the plugin
		...
		messages: {
				...
				agree: "You have to agree the Terms And Conditions before you can continue",
				agreeprivp: "You have to agree the Privacy Policy before you can continue",
		},
    		...
    		jQuery.ajax({
		      ...
		      success:function(data){
		      	 if(data.type=='success') { //Success
		      	 	$('#display_msg').html('<div class="text-center custom-alert custom-success">'+data.msg+' <input type="button" class="btn btn-info" onclick="funcCloseMsg();" value="Ok" /></div>');
		      	 }
		      	 else { //Error
...
//Set cookie data
$("#accpetdata").click(function(event) {
...
function setAgreeCookie(){
	...
	document.cookie="myscorebet_cookie=comply_yes; expires="+expire;
 }