...
<head>
    ...
    <link rel="stylesheet" href="{{ assetPath('plugins/timepicker/bootstrap-timepicker.min.css') }}">        
    <link rel="stylesheet" href="{{ assetPath('plugins/datepicker/datepicker3.css') }}">  
    <link rel="stylesheet" href="{{ assetPath('plugins/daterangepicker/daterangepicker.css') }}">
...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                  ...
                  <div class="pull-left info">
                    ...
                    <p>
                        {!! Form::open(['url'=>'admin/logout']) !!}
                            <button type="submit" class="btn" style="width:90px;background-color: #0000004a;border: none; color: #b8c7ce;"><small></small><i class="fa fa-sign-out"></i> <span>Logout</span></small></button>
                        {!! Form::close() !!}
                    </p>
                   <!--   <p>
    ...
    @if (config('app.debug', true))
        ...
        <script src="{{ assetPath('js/admin-custom.js') }} "></script>
    @else
        <script src="{{ assetPath('js/admin-all.js') }} "></script>
    @endif
        ...
        <script src="{{ assetPath('plugins/timepicker/bootstrap-timepicker.min.js') }} "></script>
        <script src="{{ assetPath('plugins/datepicker/bootstrap-datepicker.js') }} "></script>
        <script src="{{ assetPath('plugins/daterangepicker/moment.min.js') }}"></script>
        <script src="{{ assetPath('plugins/daterangepicker/daterangepicker.js') }}"></script>

        <!--For specific route -->
        @if (Request::is('admin/subevents/create') || Request::is('admin/subevents/*/edit'))
        <script src="{{ assetPath('js/jquery.min.js') }} "></script>
        @endif
        
        <script src="{{ assetPath('js/bootstrap-datetimepicker.js') }} "></script>
        <script src="{{ assetPath('js/bootstrap-datetimepicker.fr.js') }} "></script>
